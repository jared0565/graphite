...
class Config:
    ...
    cache_version: str = "v4"  # bump on extraction-format changes (v4: full-path node ids, workspace imports, phantom-edge drop)
    workers: int = 4
    ...
    def from_env(cls, overrides: dict[str, str] | None = None) -> "Config":
        ...
        return cls(
            ...
            cache_version=env.get("graphite_cache_version", "v4"),
