...
class Config:
    ...
    cache_version: str = "v6"  # bump on extraction-format changes (v6: per-package tsconfig path aliases; v5: resolve JS-extension + ".."-relative imports; v4: full-path node ids, workspace imports, phantom-edge drop)
    workers: int = 4
    ...
    def from_env(
        ...
        *,
        ...
        config = cls(
            ...
            cache_version=env.get("graphite_cache_version", "v6"),
