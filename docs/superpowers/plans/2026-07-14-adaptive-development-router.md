...
- [x] **Step 1: Verify the original worktree and preserve unrelated changes**
...
- [x] **Step 2: Create an isolated feature worktree from the committed plan**
...
- [x] **Step 3: Run the controlled baseline in the feature worktree**
...
- [x] **Step 4: Confirm routing has no existing authority**
...
- [x] **Step 1: Write red tests for engine identity**
...
- [x] **Step 2: Demonstrate the red state**
...
- [x] **Step 3: Implement bounded engine identity**
...
- [x] **Step 4: Write the identity into build manifests and compare it in freshness**
...
- [x] **Step 3: Implement `load_validated_graph_bundle()`**
...
- [x] **Step 4: Replace direct consumers**
...
- [x] **Step 5: Run focused tests and security regressions**
...
- [x] **Step 1: Write red serialization and validation tests**
...
- [x] **Step 4: Implement isolated settings**
...
- [x] **Step 4: Add ignore/onboarding support**
...
- [x] **Step 1: Verify current official Ollama contracts**
...
- [x] **Step 2: Write red registry tests**
...
- [x] **Step 3: Implement model profiles**
...
- [x] **Step 4: Implement bounded loopback inventory refresh**
...
- [x] **Step 2: Write red context/security tests**
...
- [x] **Step 1: Write red eligibility and scoring tests**
...
- [x] **Step 2: Write red Wilson-confidence tests**
...
- [x] **Step 3: Implement approval integrity**
...
- [x] **Step 4: Implement atomic consume/settle**
...
- [x] **Step 1: Write red fake-server contract tests**
...
- [x] **Step 4: Return a sanitized receipt and ephemeral result**
...
- [x] **Step 1: Write red outcome-provenance tests**
...
- [x] **Step 2: Write red aggregate-sanitization tests**
...
- [x] **Step 4: Implement append-only outcome events and derived views**
...
- [x] **Step 5: Implement sanitized aggregate export**
...
- [x] **Step 1: Write red shadow-policy tests**
...
- [x] **Step 3: Implement shadow selection and accounting**
...
- [x] **Step 4: Implement pairwise evidence contract**
...
- [x] **Step 1: Write red CLI grammar and authority tests**
...
- [x] **Step 4: Implement manual frontier handoff**
...
- [x] **Step 5: Run CLI and no-authority regressions**
...
- [x] **Step 2: Add a read-only readiness check if justified**
...
- [x] **Step 3: Update architecture and operator docs**
...
- [x] **Step 4: Run documentation/readiness tests**
...
- [x] **Step 1: Define a versioned, non-proprietary task corpus**
...
- [x] **Step 2: Write red benchmark-schema tests**
...
- [x] **Step 3: Implement offline evaluation first**
...
- [x] **Step 4: Compare policies without overstating causality**
...
- [x] **Step 5: Run benchmark tests and lint**
...
- [x] **Step 1: Run focused routing suites**
...
- [x] **Step 2: Run authority-boundary regressions**
...
- [x] **Step 3: Run the controlled full suite and static checks**
...
- [x] **Step 4: Prove no-network and no-mutation defaults**
...
- [x] **Step 6: Rebuild and validate Graphite's own graph**
...
- [x] **Step 7: Audit public artifacts for sensitive data**
...
- [x] **Step 8: Mark the design implemented and commit acceptance evidence**
...
- [x] **Step 9: Review branch history and integrate safely**
