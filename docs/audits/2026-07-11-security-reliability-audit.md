...
- **Exit semantics:** Risk is advisory. Only `--fail-on-blocker` plus a non-empty blocker list returns `1` ([`src/graphite/cli.py:655-659`](../../src/graphite/cli.py#L655)); a high-risk packet without blockers remains successful ([`tests/test_review.py:978-986`](../../tests/test_review.py#L978)).
